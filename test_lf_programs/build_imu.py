#!/usr/bin/env python3
"""
ACT for imu -> test inside a Nix develop shell.
...
def build():
    ...
    lf_file = "src/SensorsTiltSolution.lf"
    elf_path = "bin/SensorsTiltSolution.elf"

    # -f for force -> Needs it since we have no other way to BOOTSEL
    shell_cmd = f"""
        set -e
